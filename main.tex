...
The scripts and data created for this paper, as well as its \LaTeX, are available on the public NEMUS organisation GitHub repository and the associated Zenodo archive \cite{this_paper}.
