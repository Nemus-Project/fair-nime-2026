...
% And high contrast: https://cran.r-project.org/web/packages/khroma/vignettes/tol.html#sec:high-contrast
\definecolor{highContrast1}{HTML}{004488}
\definecolor{highContrast2}{HTML}{ddaa33}
\definecolor{highContrast3}{HTML}{bb5566}
...
\affiliation{%
  \institution{Dept. of Industrial Engineering, Universit\`a di Bologna}
  \city{Bologna}  
  \country{Italy}
}
...
% \input{structure}
\input{article} % Word count - 200 words to cover the abstract
