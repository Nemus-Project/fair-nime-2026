...
% Alt Titles:
\title{``Email Author(s) for Title'': Towards a Pragmatic Open Methodology at NIME [working title]}
\title{Mind the Gap: Towards a Pragmatic Open Methodology at NIME [working title]}
\title{The Rest of the Owl: Towards a Pragmatic Open Methodology at NIME [working title]}
%%
