    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[
                ...
                \addlegendentry{Referencing any git}
                \addplot[
                color=red,
                mark=*,
                smooth
                ...
                \addlegendentry{Referencing GitHub}
        \end{axis}
    \end{tikzpicture}
    % \caption{Yearly percentage of NIME papers 2016 -- 2025 which referenced at least one git repository.}
    \caption{Yearly percentage of NIME papers 2009 -- 2025 which referenced at least one git repository and GitHub specifically. Since git's initial release was in 2005, NIME papers between 2001 -- 2009 contain no references to it.}
    \label{}
\end{figure}
...
% \footnote{Early results needed to be pruned with reference to gitaroo man}
