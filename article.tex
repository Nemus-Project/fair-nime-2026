...
\begin{table}
    ...
    \end{tabular}
    \caption{Methods for disseminating source URL in NIME 2022–2025 papers. The ``Missing'' count encompasses those papers whose URL was incorrect, repository was empty or had to be inferred from a web search.}
    \label{tab:git_placement}
\end{table}
