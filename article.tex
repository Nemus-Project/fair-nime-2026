...
Figure~\ref{fig:git_occurences}  does show a strong overlap between git technology and GitHub. From which we can deduce that most interaction with the git technology is through the GitHub platform.
