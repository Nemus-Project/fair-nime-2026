...
% for including 2022 to 2024, six hours
...
\begin{table}
    ...
    \begin{tabular}{r|cccc}
                  & \textbf{2022} & \textbf{2023} & \textbf{2024} & \textbf{2025} \\ \hline
        Footnote  & 5  & 12 & 13 & 21 \\
        Body      & 7  & 8  & 6  & 8  \\
        Citation  & 1  & 1  & 3  & 2  \\
        Appendix  & 2  & 1  & 1  & 3  \\
        Missing   & 2  & 3  & 4  & 6  \\ \hline
        Total     & 17 (30\%) & 25 (25\%) & 27 (29\%) & 40 (41\%) \\
    \end{tabular}
    \caption{Methods for disseminating project source URL in NIME 2022–2025 papers. The ``Missing'' field encompasses those papers whose URL was incorrect, repository was empty or had to be inferred from a web search.}
    \label{tab:git_placement}
\end{table}
...
\begin{figure}
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Yearly percentage of NIME papers 2009 -- 2025 which referenced at least one git repository and GitHub specifically. The initial release of git  was in 2005 and NIME papers between 2001 -- 2009 contain no references to it.}
...
The percentage of NIME papers referencing a git repository each year is shown in Figure~\ref{fig:git_occurences}. There is substantial overlap between git as a technology and GitHub as a platform, suggesting that most interactions with Git occur via GitHub. Put in context of Table~\ref{tab:git_placement}, there is a \~20\% gap in those using open source work and those contributing.
...
\textbf{Main Points}
\begin{itemize}
    \item Ambiguity in disseminating repositories is clear. Including a standard field in paper template would address this
    \item Ambiguity in analysing repo usage, technique employed in section 2 is not perfect, and data though generally representative andtry to control for outliers is not completely accurate.
          \begin{itemize}
...
% A project repository and its URL are a means of doing that, but identifying them in the first place is laborious when it should be trivial.
